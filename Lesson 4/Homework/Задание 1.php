...
$job = [
		'job_name' => ['SpaceX', 'Tesla', 'OpenAI'],
		'job_data' => ['2002 - н.в.', '2003 - н.в.', '2015 - 2020'],
		'job_desc' => ['Генеральный директор и главный инженер.', 'Генеральный директор и главный архитектор продукта Tesla Motors.', 'Сопредседатель.']
]
?>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="https://tvcenter.ru/wp-content/uploads/2017/08/14894088906970.jpg" style="width:100%" alt="Avatar">
